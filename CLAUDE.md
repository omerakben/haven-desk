...
- ⏳ Human steps remaining: try RAG (upload a doc in OWUI, ask) — engine + embeddinggemma are wired; build the macOS capture Shortcut from the documented recipe (Settings → Quick capture). See `HANDOFF-CONTINUE.md`.
